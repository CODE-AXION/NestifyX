                                                    ...
                                                    <div class="my-5 w-full">
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="relative h-11 w-44">
                                                                <input placeholder="Search... "  id="tree-search" class="shadow-sm px-4 py-1 border border-gray-200 outline-0 rounded-lg mr-2 my-4 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400">
                                                            </div>
                                                        </div>
